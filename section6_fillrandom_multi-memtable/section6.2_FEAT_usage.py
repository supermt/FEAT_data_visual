...
if __name__ == '__main__':
    ...
    batch_size_curve = {}
    thread_number_curve = {}
    TEA_only_dir = "../FAST/section6.1_FEAT_usage/TEA"
    FEA_only_dir = "../FAST/section6.1_FEAT_usage/FEA"
    FEAT_dir = "../FAST/section6.1_FEAT_usage/FEAT"
    ...
    for device in devices:
        ...
        row_count += 1
    label_list = [TEA_line, FEAT_line, FEA_line, ]

    plot_labels = ["ADOC-T", "ADOC", "ADOC-B"]
