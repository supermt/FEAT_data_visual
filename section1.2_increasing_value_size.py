...
if __name__ == '__main__':
    ...
    for col in range(col_num):
        ...
        for i in range(material_count):
            ...
            plt.tight_layout()
    plt.savefig("fig_results/motivation-increasing_value_size.pdf")
    plt.savefig("fig_results/motivation-increasing_value_size.png")
